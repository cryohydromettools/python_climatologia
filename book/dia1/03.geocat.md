...
Ahora desde el terminar, podemos activar geocat y correr este [script](./03a.NCL_overlay_11a.py) para saber que todo esta yendo bien. Este script es un ejemplo de [**GeoCat**](https://geocat-examples.readthedocs.io/en/latest/gallery/index.html). 
